...
TITLE_KEYWORD_TO_CATEGORY_RAW = {
    ...
    "dungeons": "List - Gaming Events, List - Cosplay Anime Comics",
    ...
    "art a la cart": "List - Art and Crafting Events",
    "learn to draw": "List - Art and Crafting Events",
    ...
    "ghost": "List - Fall - Family Halloween Events",
    "haunted": "List - Fall - Family Halloween Events",
    "pumpkin": "List - Fall - Family Halloween Events",
    "Spooktacular": "List - Fall - Family Halloween Events",
    ...
    "hanukkah": "List - Winter - Hanukkah Events",
    "menorah": "List - Winter - Hanukkah Events",
    "driedel": "List - Winter - Hanukkah Events",
    "latke": "List - Winter - Hanukkah Events",
    "thanksgiving": "List - Fall - Thanksgiving",
    "thankful": "List - Fall - Thanksgiving",
    "veterans day": "List - Fall - Veterans Day",
    "veteran's day": "List - Fall - Veterans Day",
    "Native American Heritage Month": "List - Fall - Native American Heritage Month",
    "Arbor Day" : "List - Spring - Arbor Day",
    "Bike Month": "List - Spring - Bike Month (May)",
    "Earth Day": "List - Spring - Earth Day",
    "Easter" : "List - Spring - Easter",
    "May the Fourth": "List - Spring - May the Fourth Star Wars Day",
    "Memorial Day": "List - Spring - Memorial Day",
    "Month of the Military Child": "List - Spring - Month of the Military Child (April)",
    "Mothers Day": "List - Spring - Mothers Day",
    "Mother's Day": "List - Spring - Mothers Day",
    "Read Across America": "List - Spring - Read Across America Events (Mar 2)",
    "Spring Break": "List - Spring - Spring Break Events",
    "St Patricks Day": "List - Spring - St Patricks Day",
    "St Patrick's Day": "List - Spring - St Patricks Day",
    "Womens History Month": "List - Spring - Womens History Month (March)",
    "4th of July": "List - Summer - 4th of July",
    "July 4th": "List - Summer - 4th of July",
    "Back To School": "List - Summer - Back To School",
    "Fathers Day": "List - Summer - Fathers Day (June)",
