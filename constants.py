...
LIBRARY_CONSTANTS = {
    ...
    "nnpl": {
        ...
        "program_type_to_categories": {
            ...
            "Reading": "List - Books & Authors, Event Location - Newport News, Audience - Free Event, Event Location – Newport News",
            "STEAM": "List - STEM/STEAM, Event Location - Newport News, Audience - Free Event, Event Location – Newport News",
