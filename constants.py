...
TITLE_KEYWORD_TO_CATEGORY_RAW = {
    ...
    "fireworks": "List - All Seasons > List - Fireworks",
...
LIBRARY_CONSTANTS = {
    ...
    "program_type_to_categories": {
        ...
        "baking": "Event Location (Category) > Event Location - Hampton, Audience > Audience - Free Event, Audience > Audience - Family Event",
        "cookie": "Event Location (Category) > Event Location - Hampton, Audience > Audience - Free Event, Audience > Audience - Family Event",
        "cupcake": "Event Location (Category) > Event Location - Hampton, Audience > Audience - Free Event, Audience > Audience - Family Event",
        ...
        "music": "Event Location (Category) > Event Location - Hampton, Audience > Audience - Free Event, Audience > Audience - Family Event",
        "dance": "Event Location (Category) > Event Location - Hampton, Audience > Audience - Free Event, Audience > Audience - Family Event",
